...
inline auto shorterString(const string &s1, const string &s2) -> const string & {
    cout << __func__ << ": const reference" << endl;
    return s1.size() <= s2.size() ? s1 : s2;
}

// plain reference: a kind of work around
inline string &shorterString(string &s1, string s2) {
    cout << __func__ << ": plain reference" << endl;
...
int main() {
    ...
    // call with string literals
    cout << shorterString("hello", "world").size() << endl;
