...
//using PF = int(vector<int>::iterator, vector<int>::iterator);
//PF *pf2 = min_element;

// just like array, compiler will turn function to a function pointer
decltype(min_element) *pf2 = min_element;
